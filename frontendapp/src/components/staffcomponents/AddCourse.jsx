...
//     alert("Please enter atleast 500 characters");
//    }
//    else{
...
//          <textarea rows = "7" className='course-form-textfield' placeholder="Maximum characters are 2000" type='text' value={password} onChange={(event=>setPassword(event.target.value))}/>
